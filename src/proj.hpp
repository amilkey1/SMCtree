...
namespace proj {
    ...
    inline void Proj::processCommandLineOptions(int argc, const char * argv[]) {
        ...
        ("mu",  value(&G::_mu)->default_value(0.0), "true extinction rate for simulating tree under the constant-rates Birth-Death model if startmode is 'smc'")
        ...
        ("_prior_distribution", boost::program_options::value(&G::_prior_distribution)->default_value(0), "use gamma (1) or exponential (0) for parameter prior distributions")
